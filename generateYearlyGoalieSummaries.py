...
for index, row in allPlayerIds.iterrows():
    ...
    cols = ['year', 'num_shots_against', 'pred_goals_against', 'act_goals_against', 'act_save_perc', 'pred_save_perc', 'saves_added_per_shot', 'playoff']
    for name, start, end, p in segments:
        shots = allShots.loc[
